  ...
  <transition appear enter-active-class="fadeInUp">
    <div class="animated">
      ...
      <p :class="['thin', 'color']">
        ...
        <br />
        There you could <router-link to="/blog/">See The Post List</router-link> or know something <router-link to="/about/">About Me</router-link>, or share your idea, I will be extremely happy if you share something to me.
        <br />
        ...
        <br />
        Although I know, I am a new fish in coding, but I have always been proud of my work. Have your nice trip here, thank you so much.</p>
    </div>
  </transition>
</template>
